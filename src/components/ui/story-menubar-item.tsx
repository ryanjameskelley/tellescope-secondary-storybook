...
import { MenubarItem, MenubarShortcut } from "./menubar";

// Reusable Menu Bar Item Component
export function StoryMenubarItem({ 
  children, 
  state = "default", 
  showShortcut = false, 
  shortcut = "⌘P", 
  ...
  const getProps = () => {
    const baseClassName = showCheck 
      ...
      : "flex justify-between items-center px-2 py-1.5 rounded-sm";
