...
function ContactsContent({ showSidebar = false, onToggleSidebar }: { showSidebar?: boolean; onToggleSidebar?: () => void } = {}) {
          ...
          <div className="flex items-center gap-2">
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent side="left" className="p-0 w-80">
                <AppSidebar activePage="contacts" />
              </SheetContent>
            </Sheet>
    ...
    <SidebarProvider>
      <div className="flex bg-background w-screen">
        ...
        <div className="flex-1 min-w-0">
          <ContactsContent showSidebar={showSidebar} onToggleSidebar={() => setShowSidebar(!showSidebar)} />
        </div>
      </div>
    </SidebarProvider>
  )
