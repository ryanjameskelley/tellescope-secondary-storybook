...
function DashboardContent({ showSidebar = false, onToggleSidebar }: { showSidebar?: boolean; onToggleSidebar?: () => void } = {}) {
    ...
    <SidebarProvider>
      <div className="flex bg-background w-screen">
        ...
        <div className="flex-1 min-w-0">
          <DashboardContent showSidebar={showSidebar} onToggleSidebar={() => setShowSidebar(!showSidebar)} />
        </div>
      </div>
    </SidebarProvider>
  )
